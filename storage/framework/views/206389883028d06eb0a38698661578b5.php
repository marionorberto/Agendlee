...
<main class="d-flex justify-content-around align-items-center">
  <div></div>
  <form action="<?php echo e(route('contact.store')); ?>" method="post" class="form w-50 form-create-contact">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kenny/Desktop/WWW/web-contact-registration/resources/views/contact/create.blade.php ENDPATH**/ ?>