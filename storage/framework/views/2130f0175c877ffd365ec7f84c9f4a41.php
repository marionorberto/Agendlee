...
<div class="container d-flex flex-column justify-content-center align-items-center pt-5">
  ...
  <form action="http://localhost:8000/login" method="post" class="form-login form-control p-4">
    ...
    <div>
      <a href="<?php echo e(route('password-recovering')); ?>"
...
<?php echo $__env->make('layout.no-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kenny/Desktop/WWW/web-contact-registration/resources/views/login.blade.php ENDPATH**/ ?>