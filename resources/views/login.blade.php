...
<div class="container d-flex flex-column justify-content-center align-items-center pt-5">
  ...
  <form action="http://localhost:8000/login" method="post" class="form-login form-control p-4">
    ...
    <div class="">
      ...
      <div>
        <a href="#" class="fs-5 text-end link-forget-password d-block m-2 text-decoration-none">Forgot Password?</a>
        <span class="fs-5 d-flex justify-content-center mt-3">Not a member?  <a href="http://localhost:8000/register" class="text-decoration-none link-forget-password"> Register</a></span>
      </div>
    </form>
</div>
@endsection
